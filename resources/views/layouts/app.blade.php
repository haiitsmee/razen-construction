...
<head>
    ...
    <title>Razen Construction - Portfolio Detail</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <style>
        :root { --color-cashmere: #D4B996; }
    ...
    <header class="sticky top-4 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
        <nav class="relative max-w-2xl w-full bg-white/80 backdrop-blur-md border border-stone-200 rounded-[24px] mx-2 flex flex-wrap md:flex-nowrap items-center justify-between p-2 ps-4 md:py-0 sm:mx-auto shadow-sm overflow-hidden">
            ...
            <div class="flex items-center">
                <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none" href="{{ route('home') }}">
            ...
            <div class="flex items-center gap-3 md:order-4 md:ms-6 pe-1">
                <a class="py-2 px-5 inline-flex items-center gap-x-2 text-sm font-semibold rounded-full bg-stone-800 text-white hover:bg-stone-700 transition-all shadow-sm" 
